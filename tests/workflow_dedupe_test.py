...
class WorkflowDedupeTest(unittest.TestCase):
    def test_main_workflow_has_github_schedule_fallback_and_guards_stale_runs(self):
        ...
        self.assertIn('cron: "20 16 * * *"', workflow)
        self.assertIn('cron: "40 16 * * *"', workflow)
        self.assertIn('cron: "20 17 * * *"', workflow)
        self.assertIn('cron: "20 18 * * *"', workflow)
        self.assertIn('cron: "0 22 * * *"', workflow)
        self.assertIn('cron: "20 22 * * *"', workflow)
        self.assertIn('cron: "40 22 * * *"', workflow)
        self.assertIn('cron: "20 23 * * *"', workflow)
        self.assertIn('cron: "20 0 * * *"', workflow)
        self.assertIn('cron: "0 4 * * *"', workflow)
        self.assertIn('cron: "20 4 * * *"', workflow)
        self.assertIn('cron: "40 4 * * *"', workflow)
        self.assertIn('cron: "20 5 * * *"', workflow)
        self.assertIn('cron: "20 6 * * *"', workflow)
        self.assertIn('cron: "20 7 * * *"', workflow)
        self.assertIn('cron: "20 8 * * *"', workflow)
        self.assertIn('cron: "0 10 * * *"', workflow)
        self.assertIn('cron: "20 10 * * *"', workflow)
        self.assertIn('cron: "40 10 * * *"', workflow)
        self.assertIn('cron: "20 11 * * *"', workflow)
        self.assertIn('cron: "20 12 * * *"', workflow)
        self.assertIn('cron: "20 13 * * *"', workflow)
        self.assertIn('cron: "20 14 * * *"', workflow)
